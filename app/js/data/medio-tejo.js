  ...
  var data = {
    ...
    solutions: {
      ...
      drawers: [
        ...
        },
        {
          ...
          body: 'The bus averaged 200 km a day across circuits serving all 11 municipalities. Urban route based in <strong>Abrantes</strong> (Nov 2023–Feb 2024), then an inter-city route based in <strong>Tomar</strong> (Feb–June 2024), deliberately including student-transport routes to help spread awareness of the technology.',
          stats: [
    ...
    system: {
      ...
      nodeData: {
        ...
        urban: { title: 'Urban route · Abrantes', tag: 'Nov 2023 – Feb 2024', body: 'The first duty cycle: a dense urban circuit based in Abrantes, refuelled at the Municipal Shipyard station.' },
        intercity: { title: 'Inter-city route · Tomar', tag: 'Feb – June 2024', body: 'The second duty cycle: a longer inter-city route based in Tomar, including student-transport routes to spread awareness of the technology.' },
    ...
    process: {
      ...
      steps: [
        ...
        { date: 'Feb 2024', text: 'Refuelling station relocates to Tomar; the bus shifts to the inter-city route.' },
