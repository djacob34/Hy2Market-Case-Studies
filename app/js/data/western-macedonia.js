...
(function (root) {
  ...
  system: {
    ...
    branches: [
      ...
      { id: `consulting`, kicker: `OPTIONAL`, name: `DEPA Commercial's Green Hydrogen Strategy*`, sub: `Hydrogen strategy consulting`, title: `DEPA Commercial's Green Hydrogen Strategy — CluBE's advisory role (optional)` }
    ],
    nodeData: {
